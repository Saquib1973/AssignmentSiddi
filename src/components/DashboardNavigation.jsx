...
const DashboardNavigation = () => {
    ...
    return (
        <div className='flex bg-grey'>
            {/* SideBar */}
            <div className={`flex flex-col py-10 px-6 transition-all sticky top-0 left-0  bg-blue text-white/80 justify-evenly md:justify-between max-md:py-28 h-[100vh]  md:h-screen ${mobileNav === false ? "max-md:-translate-x-[50vw]" : "max-md:translate-x-0"} max-md:fixed  max-md:top-0 max-md:left-0 `}>
